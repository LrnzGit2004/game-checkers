...
class Game {
  ...
  handleClick(event) {
    if (this.state.currentPlayer === this.PLAYERS.AI || this.state.isAIPlaying)
      return;
  ...
  handleSelectedPieceMove(row, col) {
    const move = this.board.possibleMoves.find(
  ...
  switchPlayer() {
    this.state.currentPlayer =
      this.state.currentPlayer === this.PLAYERS.HUMAN
        ? this.PLAYERS.AI
        : this.PLAYERS.HUMAN;
